...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            # Densification
            if iteration < opt.densify_until_iter and not args.frozen_init_pts:
...
if __name__ == "__main__":
    setproctitle.setproctitle("wxh train")
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[30_000, 50_000])
